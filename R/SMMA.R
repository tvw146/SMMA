...
#' 
#' @description  Efficient design matrix free procedure for soving the soft maximin problem for 
...
#'
#' @details We consider the maximin effects estimator for array data with a known fixed group structure 
